...
namespace FruitTracker {
    internal class EntranceMedallionIcon : StackedIcons {
        ...
        public string[][] ImageSets {
            set {
                ...
                imageSources = new [] { new string[] { }, new [] { "icons/items/bombos.png" }, new [] { "icons/items/ether.png" }, new [] { "icons/items/quake.png" } };
                UpdateIcon();
            }
        }

        public EntranceMedallionIcon() : base() {
            Dock = DockStyle.Fill;
